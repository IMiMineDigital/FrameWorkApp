...
//     _MypersonalPricebtn.selected=YES;
//    personalAd=false;
//     NSString*title=_MypersonalPricebtn.titleLabel.text;
//    if (personalAd==false)
//    {
//        if ([title isEqualToString:NSLocalizedString(@"Personal Ad", @"")])
//        {
//            _MypersonalPricebtn.titleLabel.textColor=[UIColor redColor];
//            //[self Togglebtn];
//            // [_MypersonalPricebtn setTitle:NSLocalizedString(@"More Savings", @"") forState:UIControlStateNormal];
//            [_MypersonalPricebtn setTitle:NSLocalizedString(@"Personal Ad", @"") forState:UIControlStateNormal];
//            isCheckCircular=1;
...
////        [self Togglebtn];
////        isCheckCircular=0;
////        [self AddMoreCouponseController];
////    }
